...
import com.example.banset.TitlePopup.OnItemOnClickListener;
...
//    private static final String PATH = "/data/data/com.example.banset/files/";
    
//	private static final String ACTION = "com.example.banset.action.NEW_FILE";
//	private static final String ACTION_FINISH = "com.example.banset.action.UPLOAD_FINISH";
	...
	Handler myHandler = new Handler(){
		public void handleMessage(Message msg) {	 
			...
			case -1:	
				pd.dismiss(); 
				Toast.makeText(ListCarActivity.this,"获取设备失败，请重新尝试！",Toast.LENGTH_LONG).show();	            	
//				adapter.notifyDataSetChanged();
				break;
			case 0:		   
				pd = ProgressDialog.show(ListCarActivity.this, "", "正在从云端加载列表 ...");
			    break;
			case 1:	 
        	    reload();
        	    adapter.notifyDataSetChanged(); 
	    ...
	    listView.setOnItemClickListener(new OnItemClickListener(){ 
	         public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
	        	 if(stat_list.get(arg2).equals("1")){
						...
						intent.setClass(ListCarActivity.this, LedActivity.class);
						ListCarActivity.this.startActivity(intent);
	        	 }else{
	        		 Toast.makeText(ListCarActivity.this,"目标设备不在线 ！",Toast.LENGTH_LONG).show();	            	
	        	 }
...
//		serviceIntent.setAction("com.example.banset.service");
				...
				case 2:
					 ...
					 if(ssid.indexOf("Doit_ESP") != -1){
						 ...
						 new AlertDialog.Builder(ListCarActivity.this)
			                ...
			                .setTitle("提示")
			                .setMessage("请进入手机WIFI设置, 选择热点 Doit_ESP_XXXXXX, 默认不需要密码, 完成后重新进入手工配置 ！")
